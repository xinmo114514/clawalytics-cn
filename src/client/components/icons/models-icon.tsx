  ...
  if (active) {
    return (
      ...
      >
        ...
        <rect x="5" y="5" width="14" height="14" rx="2" fill="hsl(var(--primary-muted))" strokeWidth="1" />
        <rect x="5" y="5" width="14" height="3" rx="1" fill="hsl(var(--primary-light))" strokeWidth="1" />
        <rect x="5" y="5" width="14" height="14" rx="2" stroke="hsl(var(--foreground))" strokeLinecap="round" strokeLinejoin="round" fill="none" strokeWidth="1" />
        <rect x="8" y="8" width="8" height="8" rx="1" fill="hsl(var(--destructive))" stroke="hsl(var(--foreground))" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
        {/* Pins */}
        <path d="M8 5V2" stroke="hsl(var(--foreground))" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
        <path d="M12 5V2" stroke="hsl(var(--foreground))" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
        <path d="M16 5V2" stroke="hsl(var(--foreground))" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
        <path d="M8 22v-3" stroke="hsl(var(--foreground))" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
        <path d="M12 22v-3" stroke="hsl(var(--foreground))" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
        <path d="M16 22v-3" stroke="hsl(var(--foreground))" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
        <path d="M5 8H2" stroke="hsl(var(--foreground))" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
        <path d="M5 12H2" stroke="hsl(var(--foreground))" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
        <path d="M5 16H2" stroke="hsl(var(--foreground))" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
        <path d="M22 8h-3" stroke="hsl(var(--foreground))" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
        <path d="M22 12h-3" stroke="hsl(var(--foreground))" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
        <path d="M22 16h-3" stroke="hsl(var(--foreground))" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" />
      </svg>
    )
  }
